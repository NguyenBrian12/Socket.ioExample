        ...
        .map(tenant => (
          <div id="users-list" class="list-group position-relative">
            <div class="users-list-padding">
              {tenant.message ? (
                <a
                  class="list-group-item bg-blue-grey bg-lighten-5 border-right-primary border-right-2"
                  onClick={() => props.toWhichTenant(tenant)}
                >
                  <span class="media">
                    <span class="avatar avatar-md avatar-online mr-2">
                      <img
                        class="media-object d-flex mr-3 bg-primary rounded-circle"
                    ...
                    <div class="media-body">
                      <h6 class="list-group-item-heading">
                        ...
                        <span class="float-right info">
                          {tenant.dateCreated ? moment(tenant.dateCreated).format("ddd LT") : ""}
                        </span>
                      </h6>
                      <p class="list-group-item-text text-muted">{tenant.message}</p>
                    </div>
                  </span>
                </a>
              ) : (
